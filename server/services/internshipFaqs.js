const INTERNSHIP_FAQS = [
  ...
  },
  {
    ...
    answer: 'No. Summership 2026 is a VLED Lab initiative. The certificate is issued by the Vicharanashala Lab for Education Design, not centrally by the institute. IIT Ropar runs a separate institutional summer research internship through its own office.',
  ...
  // 7. Rosetta journal
  {
    ...
    answer: 'Rosetta is your internship journal — a 65-day document, one entry per day, for the full duration of Summership 2026. You write in it daily, keep it privately, and submit it at the end of the internship as one of your completion requirements.',
  ...
  },
  {
    ...
    answer: 'Penalty scores are assigned when the system detects disengagement — like looking away, walking away, or attempting to skip content. These scores are tracked against your overall engagement metrics. High penalty scores can affect your progress and may result in being moved to the next batch if thresholds are crossed.',
  ...
  },
  {
    ...
    answer: 'Linear Progression means you must complete lessons and quizzes in the predetermined order. You cannot skip ahead or jump to later sections. This ensures foundational knowledge is built before moving to advanced topics.',
